...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_FALCON_MAMBA2,    "falcon-mamba2"    },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_FALCON_MAMBA2_USE_MLP,  "%s.mamba_use_mlp"      },

    { LLM_KV_FALCON_MAMBA2_ATTENTION_IN_MULTIPLIER,  "%s.attention_in_multiplier"  },
    { LLM_KV_FALCON_MAMBA2_ATTENTION_OUT_MULTIPLIER, "%s.attention_out_multiplier" },
    { LLM_KV_FALCON_MAMBA2_SSM_IN_MULTIPLIER,        "%s.ssm_in_multiplier"        },
    { LLM_KV_FALCON_MAMBA2_SSM_OUT_MULTIPLIER,       "%s.ssm_out_multiplier"       },
    { LLM_KV_FALCON_MAMBA2_MLP_GATE_MULTIPLIER,      "%s.mlp_gate_multiplier"      },
    { LLM_KV_FALCON_MAMBA2_MLP_DOWN_MULTIPLIER,      "%s.mlp_down_multiplier"      },
    { LLM_KV_FALCON_MAMBA2_SSM_MULTIPLIERS_0,        "%s.ssm_multipliers.0"        },
    { LLM_KV_FALCON_MAMBA2_SSM_MULTIPLIERS_1,        "%s.ssm_multipliers.1"        },
    { LLM_KV_FALCON_MAMBA2_SSM_MULTIPLIERS_2,        "%s.ssm_multipliers.2"        },
    { LLM_KV_FALCON_MAMBA2_SSM_MULTIPLIERS_3,        "%s.ssm_multipliers.3"        },
    { LLM_KV_FALCON_MAMBA2_SSM_MULTIPLIERS_4,        "%s.ssm_multipliers.4"        },
    { LLM_KV_FALCON_MAMBA2_MAMBA_NORM_BEFORE_GATE,   "%s.mamba_norm_before_gate"   },
    { LLM_KV_FALCON_MAMBA2_MAMBA_RMS_NORM,           "%s.mamba_rms_norm"           },

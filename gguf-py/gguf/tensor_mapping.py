...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.OUTPUT: (
            "embed_out",                 # gptneox
            "lm_head",                   # gpt2 mpt falcon llama-hf baichuan qwen mamba dbrx jais nemotron exaone olmoe olmo2 phimoe falcon-h1
        ...
        MODEL_TENSOR.OUTPUT_NORM: (
            ...
            "model.final_layernorm",                   # persimmon falcon-h1
            "lm_head.ln",                              # phi2
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "model.layers.{bid}.input_layernorm",                   # llama-hf nemotron olmoe phimoe falcon-h1
        ...
        MODEL_TENSOR.FFN_GATE: (
            ...
            "model.layers.{bid}.feed_forward.gate_proj",  # falcon-h1
        ),
